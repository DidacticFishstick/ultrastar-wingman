...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new UltraStarWingman.BodyVerifyVerifyAuthVerifyPost();
  });
  ...
  describe('BodyVerifyVerifyAuthVerifyPost', function() {
    it('should create an instance of BodyVerifyVerifyAuthVerifyPost', function() {
      ...
      //var instance = new UltraStarWingman.BodyVerifyVerifyAuthVerifyPost();
      //expect(instance).to.be.a(UltraStarWingman.BodyVerifyVerifyAuthVerifyPost);
    });
