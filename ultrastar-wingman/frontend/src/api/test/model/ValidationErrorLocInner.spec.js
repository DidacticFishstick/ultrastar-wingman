...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new UltraStarWingman.ValidationErrorLocInner();
  });
  ...
  describe('ValidationErrorLocInner', function() {
    it('should create an instance of ValidationErrorLocInner', function() {
      ...
      //var instance = new UltraStarWingman.ValidationErrorLocInner();
      //expect(instance).to.be.a(UltraStarWingman.ValidationErrorLocInner);
    });
