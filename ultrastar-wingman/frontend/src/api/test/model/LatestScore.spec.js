...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new UltraStarWingman.LatestScore();
  });
  ...
  describe('LatestScore', function() {
    it('should create an instance of LatestScore', function() {
      // uncomment below and update the code to test LatestScore
      //var instance = new UltraStarWingman.LatestScore();
      //expect(instance).to.be.a(UltraStarWingman.LatestScore);
    });
