...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new UltraStarWingman.HTTPValidationError();
  });
  ...
  describe('HTTPValidationError', function() {
    it('should create an instance of HTTPValidationError', function() {
      ...
      //var instance = new UltraStarWingman.HTTPValidationError();
      //expect(instance).to.be.a(UltraStarWingman.HTTPValidationError);
    });
