...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new UltraStarWingman.ValidationError();
  });
  ...
  describe('ValidationError', function() {
    it('should create an instance of ValidationError', function() {
      ...
      //var instance = new UltraStarWingman.ValidationError();
      //expect(instance).to.be.a(UltraStarWingman.ValidationError);
    });
